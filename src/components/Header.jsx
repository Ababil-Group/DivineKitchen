              ...
              {navItems.map((item, index) => (
                ...
                >
                  {item.subNav ? (
                    <>
                      <button
                        className="flex items-center justify-between w-full py-4  text-gray-800 text-[15px] font-semibold font-lato hover:text-primary transition-colors duration-300"
